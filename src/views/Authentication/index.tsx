    ...
    const SignInCard = () => {
                ...
                <div className='auth-card-box'>
                    ...
                    {error && 
                        ...
                        <div className='auth-description-box'>
                            <div className='auth-descrpition' onClick={onSignUpLinkClickHandler}>{'신규 사용자이신가요? '}<span className='auth-description-link'>{'회원가입'}</span></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        const SignUpCard = () => {
            ...
            const onSignUpButtonClickHandler = () => {
                ...
                signUpRequest(requestBody).then((response) => signUpResponse(response as SignUpResponseDto | ResponseDto | null));
                ...
                <div className='auth-card'>
                    <div className='auth-card-box'>
                        ...
                        <div className='auth-card-bottom'>
                            ...
                            <div className='auth-description-box'>
                                <div className='auth-descrpition'>{'이미 계정이 있으신가요? '}<span className='auth-description-link' onClick={onSignInLinkClickHandler}>{'로그인'}</span></div>
                            </div>
                        </div>
                    </div>
                </div>
