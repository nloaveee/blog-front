...
import { getRelationListResquest, getSearchBoardListRequest } from 'apis';
...
export default function Search() {
    ...
    //           function : get relation  list response 함수           //
    ...
    useEffect (() => {
        ...
        getRelationListResquest(searchWord).then(getRelationListResponse);
    }, [searchWord]);
                ...
                <div className='search-relation-box'>
                    <div className='search-relation-card'>
                        <div className='search-relation-card-container'>
                            ...
                            {relativeWordList.map (word => <div className='word-badge' onClick={() => onRelationWordClickHandler}>{word}</div>)}
                            </div>
                            }
                            </div>
                        </div>
