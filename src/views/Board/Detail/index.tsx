...
export default function BoardDetail() {
        ...
        <div className="board-detail-top-header">
          ...
          <div className="board-detail-top-sub-box">
            <div className="board-detail-info-box">
              ...
              <div className="board-detail-wirte-date">
  ...
  const BoardDetailBottom = () => {
    ...
    const onFavoriteClickHandler = () => {
      ...
      PutFavoriteRequest(boardId, cookies.accessToken).then(
        putFavoriteResponse
      );
    };
    ...
    const onCommentSubmitButtonClickHandler = () => {
      if (!comment || !boardId || !loginUser || !cookies.accessToken) return;
      const requestBody: PostCommentRequestDto = { content: comment };
      postCommentRequest(boardId, requestBody, cookies.accessToken).then(
        postCommentResponse
      );
    };
          ...
          <div className="board-detail-bottom-comment-box">
            <div className="board-detail-bottom-comment-container">
              ...
              <div className="board-detail-bottom-comment-list-container">
                {viewList.map((item) => (
                  <CommnentItem commentListItem={item} />
                ))}
              </div>
            </div>
            <div className="divider"></div>
